...
|----------------------|-------------------------------------------------|--------------------------------------|--------------------------------------|
| <p align="center">[![Gltf Test](images/Buttons/GltfTest.png)](https://github.com/andriihorlov/ChessTask)</p> | A simple Unity project that demonstrates the loading and alignment of GLTF models from a web URL. It includes basic functionality for placing a reference marker in the scene, loading a model, and aligning objects based on a specified reference. The project serves as a test and prototype for handling GLTF geometry in Unity.      | <p align="center">![Completed](https://img.shields.io/badge/completed-blue) </p>        | <p align="center">[![](images/Buttons/Released.png)](https://github.com/andriihorlov/ChessTask)</p>
