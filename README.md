...
|----------------------|-------------------------------------------------|--------------------------------------|--------------------------------------|
| <p align="center">[![Gltf Test](images/Buttons/GltfTest.png)](https://github.com/andriihorlov/ChessTask)</p> | A Unity project that tests loading and aligning GLTF models from a web URL. It includes functionality for placing a reference marker and aligning the model relative to it.      | <p align="center">![Completed](https://img.shields.io/badge/completed-blue) </p>        | <p align="center">[![](images/Buttons/Released.png)](https://github.com/andriihorlov/ChessTask)</p>
